...
class MoyenneGenerale extends Component {
  ...
  fetchClasseNotes() {
    axios.get(`http://localhost:3000/notes/moyenneGenerale/${this.props.match.params.nom_classe}`)
      .then(res => {
          ...
          <Col>
            <Table>
              ...
              <tbody>
                ...
                {this.state.etudiants.map(({ etudiant, note_semestre1, note_semestre2, moyenne_generale, deliberation }, idx) => {
                  return <tr key={idx}>
