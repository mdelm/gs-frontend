...
// web services for note
export const createnote_URL= BASE_URL+'/notes/adddevoir'
export const getnote_URL= BASE_URL+'/notes/findAllnote'
export const updatenote_URL= BASE_URL+'/notes/updatenoteById/'
